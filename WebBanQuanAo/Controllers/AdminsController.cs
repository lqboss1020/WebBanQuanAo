...
namespace WebBanQuanAo.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaAdmin,Username,Password")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaAdmin,Username,Password")] Admin admin)
        {
            if (ModelState.IsValid)
            {

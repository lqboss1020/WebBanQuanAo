...
namespace WebBanQuanAo.Controllers
{
    public class NhaCungCapsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNCC,TenNCC,DiaChi,SoDT,Email")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNCC,TenNCC,DiaChi,SoDT,Email")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
